...
CREATE OR REPLACE FUNCTION "public"."match_chunks"("query_embedding" "public"."vector", "match_count" integer) RETURNS TABLE("content" "text", "document_id" "uuid", "chunk_index" integer, "similarity" double precision)
    LANGUAGE "sql" STABLE
    AS $$
  select
    dc.content,
...
CREATE OR REPLACE FUNCTION "public"."match_chunks_768"("query_embedding" "public"."vector", "match_count" integer) RETURNS TABLE("content" "text", "document_id" "uuid", "chunk_index" integer, "similarity" double precision)
    LANGUAGE "sql" STABLE
    AS $$
  select
    dc.content,
...
ALTER FUNCTION "public"."match_chunks_768"("query_embedding" "public"."vector", "match_count" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."match_chunks_arr"("query_embedding" "public"."vector", "match_count" integer) RETURNS TABLE("content" "text", "document_id" "uuid", "chunk_index" integer, "similarity" double precision)
...
ALTER FUNCTION "public"."match_chunks_arr"("query_embedding" "public"."vector", "match_count" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."match_chunks_json"("query_embedding" "jsonb", "match_count" integer) RETURNS TABLE("content" "text", "document_id" "uuid", "chunk_index" integer, "similarity" double precision)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  with q as (
...
ALTER FUNCTION "public"."match_chunks_text"("query_embedding" "text", "match_count" integer) OWNER TO "postgres";
...
CREATE OR REPLACE TRIGGER "trg_touch_chat_updated_at" AFTER INSERT ON "public"."chat_messages" FOR EACH ROW EXECUTE FUNCTION "public"."touch_chat_updated_at"();
...
CREATE POLICY "chunks_delete_via_doc_owner" ON "public"."document_chunks" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."documents" "d"
  WHERE (("d"."id" = "document_chunks"."document_id") AND ("d"."user_id" = "auth"."uid"())))));



CREATE POLICY "chunks_insert_via_doc_owner" ON "public"."document_chunks" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."documents" "d"
  WHERE (("d"."id" = "document_chunks"."document_id") AND ("d"."user_id" = "auth"."uid"())))));



CREATE POLICY "chunks_select_all_authenticated" ON "public"."document_chunks" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "documents_select_all_authenticated" ON "public"."documents" FOR SELECT TO "authenticated" USING (true);
...
GRANT ALL ON FUNCTION "public"."match_chunks_768"("query_embedding" "public"."vector", "match_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."match_chunks_768"("query_embedding" "public"."vector", "match_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_chunks_768"("query_embedding" "public"."vector", "match_count" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."match_chunks_arr"("query_embedding" "public"."vector", "match_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."match_chunks_arr"("query_embedding" "public"."vector", "match_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_chunks_arr"("query_embedding" "public"."vector", "match_count" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."match_chunks_json"("query_embedding" "jsonb", "match_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."match_chunks_json"("query_embedding" "jsonb", "match_count" integer) TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."match_chunks_text"("query_embedding" "text", "match_count" integer) TO "service_role";
...
drop extension if exists "pg_net";
  ...
  create policy "Users can upload to their own folder flreew_0"
  on "storage"."objects"
  as permissive
  for insert
  to public
with check (((bucket_id = 'documents'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));
  ...
  create policy "Users can upload to their own folder flreew_1"
  on "storage"."objects"
  as permissive
  for select
  to public
